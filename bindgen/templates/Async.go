...
func uniffiRustCallAsync[E any, T any](
	converter BufReader[*E],
	completeFunc rustFutureCompleteFunc[T],
...
// 	freeFunc func(*C.void, *C.RustCallStatus),
// ) U {
// 	rustFuture, err := uniffiRustCallAsyncInner[struct{}](nil, rustFutureFunc, pollFunc, freeFunc)
// 	if err != nil {
// 		panic(err)
// 	}
...
// func uniffiRustCallAsyncWithError[E any](
// 	converter BufReader[*E],
// 	rustFutureFunc func(*C.RustCallStatus) *C.void,
// 	pollFunc func(*C.void, unsafe.Pointer, *C.RustCallStatus),
// 	completeFunc func(*C.void, *C.RustCallStatus),
...
// func uniffiRustCallAsyncWithErrorAndResult[E any, T any, U any](
// 	converter BufReader[*E],
// 	rustFutureFunc func(*C.RustCallStatus) *C.void,
// 	pollFunc func(*C.void, unsafe.Pointer, *C.RustCallStatus),
// 	completeFunc func(*C.void, *C.RustCallStatus) T,
...
// func uniffiRustCallAsyncInner[E any](
// 	converter BufReader[*E],
// 	rustFuture uint64,
// 	pollFunc rustFuturePollFunc,
// 	completeFunc rustFutureCompleteFunc
// 	freeFunc rsutFutureFreeFunc,
// ) (uint64, *E) {
// 	pollResult := int8(-1)
// 	waiter := make(chan int8, 1)
// 	chanHandle := cgo.NewHandle(waiter)
